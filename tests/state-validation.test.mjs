...
import { mergeState, validateState } from "../lib/state-validation.mjs";
...
test("rejects missing and duplicate employee IDs", () => {
  const errors = validateState(
    { staffs: [person({ employeeId: "" }), person({ id: "STF002", employeeId: "E001" }), person({ id: "STF003", employeeId: "e001" })] },
    { partial: true },
  );
  assert.ok(errors.some((error) => error.includes("employeeId is required")));
